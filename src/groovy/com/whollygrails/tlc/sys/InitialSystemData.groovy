...
class InitialSystemData {
    ...
    private loadSystemLanguages() {
        ...
        createLanguage(name: 'Norwegian', code: 'no')
    ...
    private loadSystemCurrencies() {
        createCurrency(name: 'Afghanistan Afghani', code: 'AFA', decimals: 2, autoUpdate: false)
        createCurrency(name: 'Albanian Lek', code: 'ALL', decimals: 2, autoUpdate: true)
        createCurrency(name: 'Algerian Dinar', code: 'DZD', decimals: 0, autoUpdate: true)
        createCurrency(name: 'Angolan Kwanza', code: 'AOA', decimals: 2, autoUpdate: false)
        createCurrency(name: 'Argentine Peso', code: 'ARS', decimals: 2, autoUpdate: true)
        createCurrency(name: 'Armenian Dram', code: 'AMD', decimals: 2, autoUpdate: false)
        ...
        createCurrency(name: 'Azerbaijanian New Manat', code: 'AZN', decimals: 2, autoUpdate: false)
        ...
        createCurrency(name: 'Belarusian Ruble', code: 'BYR', decimals: 2, autoUpdate: true)
        ...
        createCurrency(name: 'Burundi Franc', code: 'BIF', decimals: 2, autoUpdate: true)
        createCurrency(name: 'Cambodian Riel', code: 'KHR', decimals: 2, autoUpdate: false)
        createCurrency(name: 'Canadian Dollar', code: 'CAD', decimals: 2, autoUpdate: true)
        createCurrency(name: 'Cape Verde Escudo', code: 'CVE', decimals: 2, autoUpdate: false)
        createCurrency(name: 'Cayman Islands Dollar', code: 'KYD', decimals: 2, autoUpdate: true)
        createCurrency(name: 'CFA Franc BCEAO', code: 'XOF', decimals: 2, autoUpdate: true)
        createCurrency(name: 'CFA Franc BEAC', code: 'XAF', decimals: 2, autoUpdate: true)
        createCurrency(name: 'CFP Franc', code: 'XPF', decimals: 2, autoUpdate: false)
        createCurrency(name: 'Chilean Peso', code: 'CLP', decimals: 2, autoUpdate: true)
        createCurrency(name: 'Chinese Yuan Renminbi', code: 'CNY', decimals: 1, autoUpdate: true)
        createCurrency(name: 'Colombian Peso', code: 'COP', decimals: 2, autoUpdate: true)
        createCurrency(name: 'Comoros Franc', code: 'KMF', decimals: 2, autoUpdate: true)
        createCurrency(name: 'Congolese Franc', code: 'CDF', decimals: 2, autoUpdate: false)
        ...
        createCurrency(name: 'Djibouti Franc', code: 'DJF', decimals: 2, autoUpdate: false)
        ...
        createCurrency(name: 'El Salvador Colon', code: 'SVC', decimals: 2, autoUpdate: true)
        createCurrency(name: 'Eritrean Nakfa', code: 'ERN', decimals: 2, autoUpdate: false)
        createCurrency(name: 'Estonian Kroon', code: 'EEK', decimals: 2, autoUpdate: true)
        ...
        createCurrency(name: 'Falkland Islands Pound', code: 'FKP', decimals: 2, autoUpdate: false)
        ...
        createCurrency(name: 'Georgian Lari', code: 'GEL', decimals: 2, autoUpdate: false)
        createCurrency(name: 'Ghanaian New Cedi', code: 'GHS', decimals: 2, autoUpdate: false)
        createCurrency(name: 'Gibraltar Pound', code: 'GIP', decimals: 2, autoUpdate: false)
        createCurrency(name: 'Guatemalan Quetzal', code: 'GTQ', decimals: 2, autoUpdate: true)
        createCurrency(name: 'Guinean Franc', code: 'GNF', decimals: 2, autoUpdate: true)
        createCurrency(name: 'Guyana Dollar', code: 'GYD', decimals: 2, autoUpdate: false)
        ...
        createCurrency(name: 'Icelandic Krona', code: 'ISK', decimals: 2, autoUpdate: true)
        createCurrency(name: 'Indian Rupee', code: 'INR', decimals: 2, autoUpdate: true)
        createCurrency(name: 'Indonesian Rupiah', code: 'IDR', decimals: 0, autoUpdate: true)
        ...
        createCurrency(name: 'Kyrgyz Som', code: 'KGS', decimals: 2, autoUpdate: false)
        createCurrency(name: 'Lao Kip', code: 'LAK', decimals: 2, autoUpdate: false)
        ...
        createCurrency(name: 'Liberian Dollar', code: 'LRD', decimals: 2, autoUpdate: false)
        createCurrency(name: 'Libyan Dinar', code: 'LYD', decimals: 3, autoUpdate: false)
        ...
        createCurrency(name: 'Macedonian Denar', code: 'MKD', decimals: 2, autoUpdate: true)
        createCurrency(name: 'Malagasy Ariary', code: 'MGA', decimals: 2, autoUpdate: false)
        ...
        createCurrency(name: 'Mauritanian Ouguiya', code: 'MRO', decimals: 1, autoUpdate: true)
        ...
        createCurrency(name: 'Moldovan Leu', code: 'MDL', decimals: 0, autoUpdate: true)
        ...
        createCurrency(name: 'Mozambique New Metical', code: 'MZN', decimals: 2, autoUpdate: false)
        createCurrency(name: 'Myanmar Kyat', code: 'MMK', decimals: 2, autoUpdate: false)
        ...
        createCurrency(name: 'North Korean Won', code: 'KPW', decimals: 2, autoUpdate: false)
        ...
        createCurrency(name: 'Paraguayan Guarani', code: 'PYG', decimals: 2, autoUpdate: true)
        ...
        createCurrency(name: 'Rwandan Franc', code: 'RWF', decimals: 2, autoUpdate: true)
        createCurrency(name: 'Saint Helena Pound', code: 'SHP', decimals: 2, autoUpdate: false)
        createCurrency(name: 'Samoan Tala', code: 'WST', decimals: 2, autoUpdate: true)
        createCurrency(name: 'Sao Tome and Principe Dobra', code: 'STD', decimals: 2, autoUpdate: true)
        createCurrency(name: 'Saudi Riyal', code: 'SAR', decimals: 2, autoUpdate: true)
        createCurrency(name: 'Serbian Dinar', code: 'RSD', decimals: 2, autoUpdate: false)
        createCurrency(name: 'Seychelles Rupee', code: 'SCR', decimals: 2, autoUpdate: true)
        createCurrency(name: 'Sierra Leone Leone', code: 'SLL', decimals: 2, autoUpdate: true)
        ...
        createCurrency(name: 'Somali Shilling', code: 'SOS', decimals: 2, autoUpdate: false)
        ...
        createCurrency(name: 'Sudanese Pound', code: 'SDG', decimals: 2, autoUpdate: false)
        createCurrency(name: 'Suriname Dollar', code: 'SRD', decimals: 2, autoUpdate: false)
        ...
        createCurrency(name: 'Syrian Pound', code: 'SYP', decimals: 2, autoUpdate: false)
        createCurrency(name: 'Taiwan New Dollar', code: 'TWD', decimals: 2, autoUpdate: true)
        createCurrency(name: 'Tajik Somoni', code: 'TJS', decimals: 2, autoUpdate: false)
        ...
        createCurrency(name: 'Turkmen Manat', code: 'TMM', decimals: 2, autoUpdate: false)
        ...
        createCurrency(name: 'US Dollar', code: 'USD', decimals: 2, autoUpdate: true)
        createCurrency(name: 'Uzbekistani Sum', code: 'UZS', decimals: 0, autoUpdate: false)
        createCurrency(name: 'Vanuatu Vatu', code: 'VUV', decimals: 2, autoUpdate: true)
        createCurrency(name: 'Venezuelan Bolivar Fuerte', code: 'VEF', decimals: 2, autoUpdate: true)
        createCurrency(name: 'Vietnamese Dong', code: 'VND', decimals: 2, autoUpdate: true)
        createCurrency(name: 'Yemeni Rial', code: 'YER', decimals: 0, autoUpdate: true)
        createCurrency(name: 'Zambian Kwacha', code: 'ZMK', decimals: 0, autoUpdate: true)
        createCurrency(name: 'Zimbabwe Dollar', code: 'ZWD', decimals: 0, autoUpdate: true)
        createCurrency(name: 'Convertible Marks', code: 'BAM', decimals: 2, autoUpdate: false)
    }
    ...
    private loadSystemCountries() {
        createCountry([name: 'Afghanistan', code: 'AF', flag: 'AF'], '034', 'ps', 'AFA')
        ...
        createCountry([name: 'Norway', code: 'NO', flag: 'NO'], '154', 'no', 'NOK')
        ...
        createCountry([name: 'Svalbard and Jan Mayen', code: 'SJ', flag: 'NO'], '154', 'no', 'NOK')
        ...
        createCountry([name: 'Turkmenistan', code: 'TM', flag: 'TM'], '143', 'tk', 'TMM')
        ...
        createCountry([name: 'Zimbabwe', code: 'ZW', flag: 'ZW'], '014', 'en', 'ZWD')
    }
    ...
    private loadMessages() {
        def path = ServletContextHolder.getServletContext().getRealPath('/')
        if (path) {
    ...
    private loadPageHelp() {
        def dir = new File(ServletContextHolder.getServletContext().getRealPath('/pagehelp'))
        if (dir.exists() && dir.canRead()) {
            def names = []
            dir.listFiles().each {
    ...
    private loadSystemRoles() {
        ...
        //        createRole(code: 'translator', name: 'Translator', activities: ['systran'])
    }

    private createRole(map) {
        def role = new SystemRole(code: map.code, name: map.name)
        role.saveThis()
        for (acty in map.activities) {
            if (acty instanceof SystemActivity) {
                role.addToActivities(acty)
            } else {
                role.addToActivities(SystemActivity.findByCode(acty))
            }
        }
    ...
    private createMenu(map) {
        ...
        map.activity = acty
        if (map.path.contains('.')) map.parentObject = SystemMenu.findByPathAndType(map.path.substring(0, map.path.lastIndexOf('.')), 'submenu')
        new SystemMenu(map).saveThis()
