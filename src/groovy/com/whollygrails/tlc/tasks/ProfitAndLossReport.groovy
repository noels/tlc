...
public class ProfitAndLossReport extends TaskExecutable {
    ...
    def execute() {
        ...
        if (!format) {
            completionMessage = message(code: 'profitReportFormat.not.found', args: [params.formatId], default: "Report Format not found with id ${params.formatId}")
            return false
        }
        ...
        reportParams.txtPeriod = message(code: 'report.period', default: 'Period')
        ...
        for (int i = 1; i <= 3; i++) {
            ...
            if (valueId) {
                ...
                if (val && bookService.createElementAccessFragment('x', val, company, user) != null) {
                    ...
                    completionMessage = message(code: 'codeElement.not.found', args: [valueId], default: "Code Element not found with id ${valueId}")
                    return false
                }
            } else {
                break
