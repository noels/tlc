...
import com.whollygrails.tlc.books.Remittance
    ...
    def execute() {
        ...
        if (params.supplier) {
            ...
            if (bookService.hasSupplierAccess(specificSupplier, company, user)) {
                ...
                completionMessage = message(code: 'supplier.not.found', args: [params.customer], default: "Supplier not found with id ${params.supplier}")
                return false
            }
        } else {
        ...
        reportParams.txtSupplier = message(code: 'remittance.supplier', default: 'Specific Supplier')
