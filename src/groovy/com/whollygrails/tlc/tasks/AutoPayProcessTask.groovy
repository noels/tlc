        ...
        Remittance.withTransaction {status ->
            for (rid in remittanceIds) {
                ...
                if (included) {
                    ...
                    lineNumber++
                    line = new Line(supplier: remittance.supplier, account: apControlAccount, documentValue: accountValue, accountValue: accountValue,
            ...
            if (document && !errorMessage) {
                line = new Total(account: bankAccount, description: description, documentValue: accountTotal, generalValue: bankTotal, companyValue: companyTotal)
