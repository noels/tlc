...
class Customer {
    ...
    static hasMany = [transactions: GeneralTransaction, turnovers: CustomerTurnover, templates: TemplateDocument, templateLines: TemplateLine, recurringLines: RecurringLine,
            addresses: CustomerAddress, addressUsages: CustomerAddressUsage, statements: Statement]
