...
class SupplierAddress {
    ...
    static belongsTo = [supplier: Supplier, country: SystemCountry, format: SystemAddressFormat]
    static hasMany = [addressUsages: SupplierAddressUsage, contacts: SupplierContact]
