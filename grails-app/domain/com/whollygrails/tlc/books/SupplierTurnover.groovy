...
class SupplierTurnover {
    ...
    static belongsTo = [supplier: Supplier, period: Period]

    BigDecimal accountTurnover = 0.0
    BigDecimal companyTurnover = 0.0
    Long securityCode = 0
    Date dateCreated
    Date lastUpdated
    ...
    static constraints = {
        accountTurnover(scale: 3)
        companyTurnover(scale: 3)
