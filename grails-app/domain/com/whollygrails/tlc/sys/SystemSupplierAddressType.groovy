...
import com.whollygrails.tlc.books.SupplierAddressUsage
import java.util.concurrent.atomic.AtomicLong

class SystemSupplierAddressType {

    static traceInsertCode = new AtomicLong()
    static traceUpdateCode = new AtomicLong()
    static traceDeleteCode = new AtomicLong()

    static hasMany = [addressUsages: SupplierAddressUsage]
    ...
    static mapping = {
        columns {
            addressUsages cascade: 'save-update'
        }
    }
