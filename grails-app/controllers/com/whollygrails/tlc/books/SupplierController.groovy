...
class SupplierController {
    ...
    def delete = {
        ...
        if (supplierInstance && bookService.hasSupplierAccess(supplierInstance)) {
            try {
                ...
                flash.args = [supplierInstance.toString()]
                flash.defaultMessage = "Supplier ${supplierInstance.toString()} deleted"
                redirect(action: list)
            } catch (Exception e) {
                flash.message = 'supplier.not.deleted'
                flash.args = [supplierInstance.toString(), e.class.simpleName]
                flash.defaultMessage = "Supplier ${supplierInstance.toString()} could not be deleted (${e.class.simpleName})"
    ...
    def update = {
        ...
        if (supplierInstance && bookService.hasSupplierAccess(supplierInstance)) {
            ...
            if (valid) {
                ...
                flash.args = [supplierInstance.toString()]
                flash.defaultMessage = "Supplier ${supplierInstance.toString()} updated"
    ...
    def save = {
        ...
        if (!supplierInstance.hasErrors() && bookService.hasSupplierAccess(supplierInstance) && bookService.insertSupplier(supplierInstance)) {
            ...
            flash.args = [supplierInstance.toString()]
            flash.defaultMessage = "Supplier ${supplierInstance.toString()} created"
    ...
    def importing = {
        ...
        if (valid) {
            flash.message = 'supplier.uploaded'
    ...
    def transactions = {
        ...
        if (!supplierInstance || !bookService.hasSupplierAccess(supplierInstance)) {
            flash.message = 'document.supplier.invalid'
            flash.defaultMessage = 'Invalid supplier'
            redirect(action: list)
            return
        }
    ...
    def printing = {
        ...
        params.p_active = supplierInstance.active
    ...
    def remittanceEnquiry = {
        ...
        if (bookService.hasSupplierAccess(supplierInstance)) {
            ...
            if (remittances) {
                ...
                if (!params.priorRemittance || params.priorRemittance.toLong() != remittanceInstance.id) params.offset = 0L
    ...
    def remittancePrint = {
        ...
        if (bookService.hasSupplierAccess(supplierInstance)) {
            ...
            if (remittanceInstance) {
                ...
                flash.args = [params.remittance]
                flash.defaultMessage = "Remittance Advice not found with id ${params.remittance}"
            }
        } else {
            flash.message = 'supplier.not.found'
            flash.args = [params.supplierId]
            flash.defaultMessage = "Supplier not found with id ${params.supplierId}"
        }
