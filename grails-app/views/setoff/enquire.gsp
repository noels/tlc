...
<head>
    ...
    <title><g:msg code="setoff.journal.enquire" default="Set-Off Journal Enquiry"/></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="setoff.journal.enquire" default="Set-Off Journal Enquiry" help="document.enquire"/>
            ...
            <table>
                ...
                <g:if test="${documentInstance.id}">
                    <tr class="prop">
                        ...
                        <td valign="top" class="name" colspan="2"><g:msg code="generalTransaction.affectsTurnover" default="Affects Turnover"/>:&nbsp;&nbsp;${display(bean: documentInstance, field: 'sourceAffectsTurnover')}</td>
            ...
            <table>
                ...
                <g:each in="${documentInstance.lines}" status="i" var="lineInstance">
                    <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                        <td><g:enquiryLink target="${(lineInstance.customer ?: lineInstance.supplier)}" displayPeriod="${documentInstance.period}" displayCurrency="${displayCurrency}">${display(bean: lineInstance, field: 'accountCode')}</g:enquiryLink></td>
