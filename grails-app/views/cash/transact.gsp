...
<head>
    ...
    <title><g:msg code="cash.entry" default="Cash Payment/Receipt Entry"/></title>
...
<div class="nav">
    ...
    <span class="menuButton"><g:link class="list" controller="document" action="templates" params="${[ctrl: 'cash', types: 'CP,CR']}"><g:msg code="templateDocument.load" default="Load Template"/></g:link></span>
</div>
<div class="body">
    <g:pageTitle code="cash.entry" default="Cash Payment/Receipt Entry"/>
    ...
    <g:form method="post">
            ...
            <table>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="sourceCode"><g:msg code="cash.account" default="Cash Account"/>:</label>
                    </td>
                    <td valign="top" class="small-value ${hasErrors(bean: documentInstance, field: 'sourceCode', 'errors')}">
                        <g:select initialField="true" onchange="accountChanged()" onblur="getBank(this, '${createLink(controller: 'document', action: 'bank')}', 'cash')" optionKey="code" optionValue="name" from="${bankAccountList}" name="sourceCode" value="${documentInstance?.sourceCode}" noSelection="['': msg(code: 'generic.select', default: '-- select --')]"/>&nbsp;<g:help code="cash.account"/>
                    </td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="name">
                        <label for="code"><g:msg code="document.bank.code" default="Code"/>:</label>
                    </td>
                    <td valign="top" class="small-value ${hasErrors(bean: documentInstance, field: 'code', 'errors')}">
                        <input ${settings.codeEdit ? '' : 'disabled="true"'} type="text" maxlength="10" size="10" id="code" name="code" value="${display(bean: documentInstance, field: 'code')}"/>&nbsp;<g:help code="document.bank.code"/>
                    </td>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="documentDate"><g:msg code="document.bankDate" default="Document Date"/>:</label>
                    </td>
                    <td valign="top" class="small-value ${hasErrors(bean: documentInstance, field: 'documentDate', 'errors')}">
                        <input type="text" onchange="getPeriod(this, '${createLink(controller: 'document', action: 'period')}', 'supplier')" size="20" id="documentDate" name="documentDate" value="${display(bean: documentInstance, field: 'documentDate', scale: 1)}"/>&nbsp;<g:help code="document.bankDate"/>
                    </td>
        ...
        <div class="list entry">
            <table>
                ...
                <tr>
                    ...
                    <th><g:msg code="document.bank.taxCode" default="Tax Code"/>&nbsp;<g:help code="document.bank.taxCode"/></th>
                ...
                <g:each in="${documentInstance.lines}" status="i" var="documentLine">
                    <tr>
                        <td class="narrow ${hasErrors(bean: documentLine, field: 'accountCode', 'errors')}">
                            <input type="text" maxLength="87" size="30" onchange="getAccount(this, '${createLink(controller: 'document', action: 'account')}', 'cash')" id="lines[${i}].accountCode" name="lines[${i}].accountCode" value="${display(bean: documentLine, field: 'accountCode')}"/>
                        </td>
        ...
        <div class="buttons">
            <span class="button"><g:actionSubmit class="save" action="transacting" value="${msg(code:'create', 'default':'Create')}"/></span>
