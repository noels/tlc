...
<head>
    ...
    <title><g:msg code="templateDocument.cash.list" default="Cash Payment/Receipt Template List" /></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="templateDocument.cash.list" default="Cash Payment/Receipt Template List"/>
