    ...
    <table>
        ...
        <tr class="prop">
            <td valign="top" class="name">
                <label for="sourceCode"><g:msg code="templateDocument.cash" default="Cash Account"/>:</label>
            </td>
            <td valign="top" class="small-value ${hasErrors(bean: templateDocumentInstance, field: 'sourceCode', 'errors')}">
                <g:select initialField="true" onchange="accountChanged()" onblur="getBank(this, '${createLink(controller: 'document', action: 'bank')}', 'cash')" optionKey="code" optionValue="name" from="${bankAccountList}" name="sourceCode" value="${templateDocumentInstance?.sourceCode}" noSelection="['': msg(code: 'generic.select', default: '-- select --')]"/>&nbsp;<g:help code="templateDocument.cash"/>
            </td>
        ...
        <tr class="prop">
            ...
            <td valign="top" colspan="3" class="small-value ${hasErrors(bean: templateDocumentInstance, field: 'type', 'errors')}">
