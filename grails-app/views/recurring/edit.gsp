...
<head>
    ...
    <title><g:msg code="recurring.edit" default="Edit Recurring Bank Transaction"/></title>
...
<div class="body">
    <g:pageTitle code="recurring.edit" default="Edit Recurring Bank Transaction"/>
    ...
    <g:if test="${settings.isComplete}">
        <div style="text-align:center;margin-bottom:15px;"><g:msg code="recurring.isComplete" default="This recurring transaction has completed and cannot be edited. It is displayed for viewing purposes only."/></div>
    </g:if>
    <g:form method="post">
