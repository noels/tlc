...
<head>
    ...
    <title><g:msg code="financial.journal.entry" default="Financial Journal Entry"/></title>
...
<div class="nav">
    ...
    <span class="menuButton"><g:link class="list" controller="document" action="templates" params="${[ctrl: 'financial', types: 'FJ']}"><g:msg code="templateDocument.load" default="Load Template"/></g:link></span>
</div>
<div class="body">
    <g:pageTitle code="financial.journal.entry" default="Financial Journal Entry"/>
