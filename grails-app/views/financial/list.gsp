...
<head>
    ...
    <title><g:msg code="templateDocument.fj.list" default="Financial Journal Template List" /></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="templateDocument.fj.list" default="Financial Journal Template List"/>
