...
<head>
    ...
    <title><g:msg code="mnemonic.show" default="Show Mnemonic" /></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="mnemonic.show" default="Show Mnemonic"/>
    ...
    <div class="dialog">
        <table>
            ...
            <tr class="prop">
                ...
                <td valign="top" class="value">${display(bean:mnemonicInstance, field:'id')}</td>
            ...
            <tr class="prop">
                <td valign="top" class="name"><g:msg code="mnemonic.code" default="Code" />:</td>

                <td valign="top" class="value">${display(bean:mnemonicInstance, field:'code')}</td>
            ...
            <tr class="prop">
                <td valign="top" class="name"><g:msg code="mnemonic.name" default="Name" />:</td>

                <td valign="top" class="value">${display(bean:mnemonicInstance, field:'name')}</td>
            ...
            <tr class="prop">
                <td valign="top" class="name"><g:msg code="mnemonic.accountCodeFragment" default="Account Code Fragment" />:</td>

                <td valign="top" class="value">${display(bean:mnemonicInstance, field:'accountCodeFragment')}</td>
            ...
            <tr class="prop">
                ...
                <td valign="top" class="value">${display(bean:mnemonicInstance, field:'securityCode')}</td>
            ...
            <tr class="prop">
                ...
                <td valign="top" class="value">${display(bean:mnemonicInstance, field:'dateCreated')}</td>
            ...
            <tr class="prop">
                ...
                <td valign="top" class="value">${display(bean:mnemonicInstance, field:'lastUpdated')}</td>
            ...
            <tr class="prop">
                ...
                <td valign="top" class="value">${display(bean:mnemonicInstance, field:'version')}</td>
