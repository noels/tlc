...
<head>
    ...
    <title><g:msg code="agentCredential.edit" default="Edit Agent Credentials" /></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="agentCredential.edit" default="Edit Agent Credential"/>
    <g:if test="${flash.message}">
        <div class="message"><g:msg code="${flash.message}" args="${flash.args}" default="${flash.defaultMessage}" /></div>
    </g:if>
    <g:hasErrors bean="${agentCredentialInstance}">
        <div class="errors">
            <g:listErrors bean="${agentCredentialInstance}" />
        </div>
    </g:hasErrors>
    <g:form method="post" >
        <input type="hidden" name="id" value="${agentCredentialInstance?.id}" />
        <input type="hidden" name="version" value="${agentCredentialInstance?.version}" />
        <g:render template="dialog" model="[agentCredentialInstance: agentCredentialInstance]" />
        <div class="buttons">
