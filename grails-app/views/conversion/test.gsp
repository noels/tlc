...
<head>
    ...
    <title><g:msg code="conversionTest.corp.title" default="Test Conversions"/></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="conversionTest.corp.title" default="Test Conversions"/>
            ...
            <table>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value ${hasErrors(bean: testInstance, field: 'fromUnit', 'errors')}">
                        <g:domainSelect initialField="true" name="fromUnit.id" options="${unitList}" selected="${testInstance?.fromUnit}" prefix="unit.name" code="code" default="name"/>&nbsp;<g:help code="conversionTest.fromUnit"/>
                    </td>
                </tr>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value ${hasErrors(bean: testInstance, field: 'toUnit', 'errors')}">
                        <g:domainSelect name="toUnit.id" options="${unitList}" selected="${testInstance?.toUnit}" prefix="unit.name" code="code" default="name"/>&nbsp;<g:help code="conversionTest.toUnit"/>
                    </td>
                </tr>
