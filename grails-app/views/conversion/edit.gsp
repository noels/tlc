...
<head>
    ...
    <title><g:msg code="conversion.edit" default="Edit Conversion" /></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="conversion.edit" default="Edit Conversion" />
    ...
    <g:form method="post" >
        ...
        <input type="hidden" name="version" value="${conversionInstance?.version}" />
        <g:render template="dialog" model="[conversionInstance: conversionInstance]" />
        <div class="buttons">
