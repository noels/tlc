...
<head>
    ...
    <title><g:msg code="period.create" default="Create Period" /></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="period.create" default="Create Period"/>
    ...
    <div style="margin:20px;text-align:center;font-size:12px;">
        <g:msg code="period.warn" default="Creating new accounting periods is a fairly heavy process. You may wish to create periods in a quiet time of day so as not to slow down normal processing."/>
    </div>
