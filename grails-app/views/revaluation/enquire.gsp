            ...
            <table>
                ...
                <tr class="prop">
                    ...
                    <g:if test="${hasBreakdown}">
                        <td valign="top" class="name">
                            <label for="breakdown"><g:msg code="document.enquire.breakdown" default="Breakdown"/>:</label>
                        </td>
                ...
                <g:if test="${documentInstance.id}">
                    <tr class="prop">
                        ...
                        <td valign="top" class="name"><g:msg code="generalTransaction.adjustment" default="Adjustment"/>:</td>
                        <td valign="top" class="value">${display(bean: documentInstance, field: 'sourceAdjustment')}</td>
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top" class="value nowrap">${display(bean: documentInstance, field: 'reference')}</td>
