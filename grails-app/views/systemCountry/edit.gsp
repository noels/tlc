...
<head>
    ...
    <title><g:msg code="systemCountry.edit" default="Edit System Country"/></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="systemCountry.edit" default="Edit System Country"/>
    <g:if test="${flash.message}">
        <div class="message"><g:msg code="${flash.message}" args="${flash.args}" default="${flash.defaultMessage}"/></div>
    </g:if>
    <g:hasErrors bean="${systemCountryInstance}">
        <div class="errors">
            <g:listErrors bean="${systemCountryInstance}"/>
        </div>
    </g:hasErrors>
    <g:form method="post">
        <input type="hidden" name="id" value="${systemCountryInstance?.id}"/>
        <input type="hidden" name="version" value="${systemCountryInstance?.version}"/>
        <g:render template="dialog" model="[systemCountryInstance: systemCountryInstance]"/>
        <div class="buttons">
