        ...
        <div class="dialog">
            <table>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value nowrap">${display(bean: supplierInstance, field: 'name')}</td>
                ...
                <tr>
                    <td valign="top" class="name nowrap"><g:msg code="supplier.accountCurrentBalance" default="Current Balance"/>:</td>
                    <td valign="top" class="value"><g:dr context="${supplierInstance}" field="balance" negate="true"/></td>

                    <td valign="top" class="name"><g:msg code="supplier.currency" default="Currency"/>:</td>
                    <td valign="top" class="value nowrap">${msg(code: 'currency.name.' + supplierInstance.currency.code, default: supplierInstance.currency.name)}</td>
