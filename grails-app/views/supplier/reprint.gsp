                ...
                <table>
                    ...
                    <tr class="prop">
                        <td valign="top" class="name">
                            <label for="code"><g:msg code="remittance.supplier" default="Specific Supplier" />:</label>
                        </td>
                        <td valign="top" class="value ${hasErrors(bean:supplierInstance,field:'code','errors')}">
                            <input initialField="true" type="text" size="20" id="code" name="code" value="${display(bean:supplierInstance,field:'code')}"/>&nbsp;<g:help code="remittance.supplier"/>
                        </td>
                    </tr>
                    ...
                    <tr class="prop">
                        <td valign="top" class="name">
                            <label for="adviceDate"><g:msg code="remittance.adviceDate" default="Advice Date" />:</label>
                        </td>
