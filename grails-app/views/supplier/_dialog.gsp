    ...
    <table>
        ...
        <tr class="prop">
            <td valign="top" class="name">
                <label for="code"><g:msg code="supplier.code" default="Code"/>:</label>
            </td>
            <td valign="top" class="value ${hasErrors(bean: supplierInstance, field: 'code', 'errors')}">
                <input initialField="true" type="text" maxlength="20" size="20" id="code" name="code" value="${display(bean: supplierInstance, field: 'code')}"/>&nbsp;<g:help code="supplier.code"/>
            </td>
        </tr>

        <tr class="prop">
            <td valign="top" class="name">
                <label for="name"><g:msg code="supplier.name" default="Name"/>:</label>
            </td>
        ...
        <tr class="prop">
            <td valign="top" class="name">
                <label for="country.id"><g:msg code="supplier.country" default="Country"/>:</label>
            </td>
        ...
        <tr class="prop">
            <td valign="top" class="name">
                <label for="currency.id"><g:msg code="supplier.currency" default="Currency"/>:</label>
            </td>
            <td valign="top" class="value ${hasErrors(bean: supplierInstance, field: 'currency', 'errors')}">
                <g:domainSelect name="currency.id" options="${currencyList}" selected="${supplierInstance?.currency}" prefix="currency.name" code="code" default="name" onchange="setRevaluation()"/>&nbsp;<g:help code="supplier.currency"/>
            </td>
        </tr>

        <tr class="prop">
            <td valign="top" class="name">
                <label for="revaluationMethod"><g:msg code="supplier.revaluationMethod" default="Revaluation Method"/>:</label>
            </td>
            <td valign="top" class="value ${hasErrors(bean: supplierInstance, field: 'revaluationMethod', 'errors')}">
        ...
        <tr class="prop">
            <td valign="top" class="name">
                <label for="taxId"><g:msg code="supplier.taxId" default="Tax Id"/>:</label>
            </td>
        ...
        <tr class="prop">
            <td valign="top" class="name">
                <label for="taxCode.id"><g:msg code="supplier.taxCode" default="Tax Code"/>:</label>
            </td>
            <td valign="top" class="value ${hasErrors(bean: supplierInstance, field: 'taxCode', 'errors')}">
        ...
        <tr class="prop">
            <td valign="top" class="name">
                <label for="accountCreditLimit"><g:msg code="supplier.accountCreditLimit" default="Credit Limit"/>:</label>
            </td>
            <td valign="top" class="value ${hasErrors(bean: supplierInstance, field: 'accountCreditLimit', 'errors')}">
        ...
        <tr class="prop">
            <td valign="top" class="name">
                <label for="settlementDays"><g:msg code="supplier.settlementDays" default="Settlement Days"/>:</label>
            </td>
            <td valign="top" class="value ${hasErrors(bean: supplierInstance, field: 'settlementDays', 'errors')}">
        ...
        <tr class="prop">
            <td valign="top" class="name">
                <label for="periodicSettlement"><g:msg code="supplier.periodicSettlement" default="Periodic Settlement"/>:</label>
            </td>
            <td valign="top" class="value ${hasErrors(bean: supplierInstance, field: 'periodicSettlement', 'errors')}">
        ...
        <tr class="prop">
            <td valign="top" class="name">
                <label for="active"><g:msg code="supplier.active" default="Active"/>:</label>
            </td>
            <td valign="top" class="value ${hasErrors(bean: supplierInstance, field: 'active', 'errors')}">
        ...
        <tr class="prop">
            <td valign="top" class="name">
                <label for="accessCode.id"><g:msg code="supplier.accessCode" default="Access Code"/>:</label>
            </td>
        ...
        <tr class="prop">
            <td valign="top" class="name">
                <label for="schedule.id"><g:msg code="supplier.schedule" default="Auto-Payment Schedule"/>:</label>
            </td>
            <td valign="top" class="value ${hasErrors(bean: supplierInstance, field: 'schedule', 'errors')}">
        ...
        <tr class="prop">
            <td valign="top" class="name">
                <label for="documentType.id"><g:msg code="supplier.documentType" default="Auto-Payment Document Type"/>:</label>
            </td>
            <td valign="top" class="value ${hasErrors(bean: supplierInstance, field: 'documentType', 'errors')}">
        ...
        <tr class="prop">
            <td valign="top" class="name">
                <label for="bankSortCode"><g:msg code="supplier.bankSortCode" default="Bank Sort Code"/>:</label>
            </td>
            <td valign="top" class="value ${hasErrors(bean: supplierInstance, field: 'bankSortCode', 'errors')}">
        ...
        <tr class="prop">
            <td valign="top" class="name">
                <label for="bankAccountName"><g:msg code="supplier.bankAccountName" default="Bank Account Name"/>:</label>
            </td>
            <td valign="top" class="value ${hasErrors(bean: supplierInstance, field: 'bankAccountName', 'errors')}">
        ...
        <tr class="prop">
            <td valign="top" class="name">
                <label for="bankAccountNumber"><g:msg code="supplier.bankAccountNumber" default="Bank Account Number"/>:</label>
            </td>
            <td valign="top" class="value ${hasErrors(bean: supplierInstance, field: 'bankAccountNumber', 'errors')}">
