            ...
            <div class="dialog">
                <table>
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top" class="value"><g:enquiryLink target="${supplierInstance}" displayPeriod="${displayPeriod}" displayCurrency="${displayCurrency}">${supplierInstance.code.encodeAsHTML()}</g:enquiryLink>&nbsp;${supplierInstance.name.encodeAsHTML()}</td>

                        <td valign="top" class="name"><g:msg code="document.currency" default="Currency"/>:</td>
                        <td valign="top" class="value">${supplierInstance.currency.code.encodeAsHTML()}</td>

                        <td valign="top" class="name">
                            <label for="remittance"><g:msg code="remittance.enquire.date" default="Remittance"/>:</label>
                        </td>
        ...
        <g:if test="${remittanceLineInstanceList}">
            <div class="list">
                <table>
                    ...
                    <tr>
                        <td colspan="4" class="right" style="font-weight:bold;">
                        ...
                        <td class="right" style="font-weight:bold;">${format(value: creditTotal - debitTotal, scale: supplierInstance.currency.decimals, locale: locale)}</td>
                        <td></td>
                    </tr>
                    <tr>
                        <td colspan="6"><hr/></td>
