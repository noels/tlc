...
<head>
    ...
    <title><g:msg code="sales.invoice.enquire" default="Sales Invoice/Cr. Note Enquiry"/></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="sales.invoice.enquire" default="Sales Invoice/Cr. Note Enquiry" help="document.enquire"/>
            ...
            <table>
                ...
                <g:if test="${documentInstance.id}">
                    <tr class="prop">
                        ...
                        <td valign="top" class="value" colspan="3"><g:enquiryLink target="${customerInstance}" displayPeriod="${documentInstance.period}" displayCurrency="${displayCurrency}">${customerInstance.code.encodeAsHTML()}</g:enquiryLink>&nbsp;${customerInstance.name.encodeAsHTML()}</td>
