    ...
    <table>
        ...
        <tr class="prop">
            <td valign="top" class="name">
                <label for="sourceCode"><g:msg code="templateDocument.customer" default="Customer"/>:</label>
            </td>
            <td valign="top" class="small-value ${hasErrors(bean: templateDocumentInstance, field: 'sourceCode', 'errors')}">
                <input initialField="true" onchange="getLedger(this, '${createLink(controller: 'document', action: 'customer')}')" type="text" maxlength="20" size="20" id="sourceCode" name="sourceCode" value="${display(bean: templateDocumentInstance, field: 'sourceCode')}"/>&nbsp;<g:help code="templateDocument.customer"/>
            </td>
