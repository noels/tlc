...
<head>
    ...
    <title><g:msg code="templateDocument.si.list" default="Sales Invoice/Cr. Note Template List" /></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="templateDocument.si.list" default="Sales Invoice/Cr. Note Template List"/>
