...
<head>
    ...
    <title><g:msg code="systemAddressFormat.edit" default="Edit Address Format" /></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="systemAddressFormat.edit" default="Edit Address Format"/>
    <g:if test="${flash.message}">
        <div class="message"><g:msg code="${flash.message}" args="${flash.args}" default="${flash.defaultMessage}" /></div>
    </g:if>
    <g:hasErrors bean="${systemAddressFormatInstance}">
        <div class="errors">
            <g:listErrors bean="${systemAddressFormatInstance}" />
        </div>
    </g:hasErrors>
    <g:form method="post" >
        <input type="hidden" name="id" value="${systemAddressFormatInstance?.id}" />
        <input type="hidden" name="version" value="${systemAddressFormatInstance?.version}" />
        <g:render template="dialog" model="[systemAddressFormatInstance: systemAddressFormatInstance]" />
        <div class="buttons">
