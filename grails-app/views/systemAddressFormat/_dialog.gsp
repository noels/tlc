...
<div class="dialog">
    <table>
        ...
        <tr class="prop">
            <td valign="top" class="name">
                <label for="code"><g:msg code="systemAddressFormat.code" default="Code"/>:</label>
            </td>
            <td valign="top" class="value ${hasErrors(bean: systemAddressFormatInstance, field: 'code', 'errors')}">
                <input initialField="true" type="text" maxlength="10" size="10" id="code" name="code" value="${display(bean: systemAddressFormatInstance, field: 'code')}"/>&nbsp;<g:help code="systemAddressFormat.code"/>
            </td>
        </tr>

        <tr class="prop">
            <td valign="top" class="name">
                <label for="name"><g:msg code="systemAddressFormat.name" default="Name"/>:</label>
            </td>
            <td valign="top" class="value ${hasErrors(bean: systemAddressFormatInstance, field: 'name', 'errors')}">
    ...
    <table>
        <thead>
        <tr>
            <th class="nowrap"><g:msg code="systemAddressFormat.field" default="Field"/>&nbsp;<g:help code="systemAddressFormat.field"/></th>
            <th class="nowrap"><g:msg code="systemAddressFormat.prompt" default="Prompts"/>&nbsp;<g:help code="systemAddressFormat.prompt"/></th>
            <th class="nowrap"><g:msg code="systemAddressFormat.width" default="Width"/>&nbsp;<g:help code="systemAddressFormat.width"/></th>
            <th class="nowrap"><g:msg code="systemAddressFormat.mandatory" default="Mandatory"/>&nbsp;<g:help code="systemAddressFormat.mandatory"/></th>
            <th class="nowrap"><g:msg code="systemAddressFormat.pattern" default="Pattern"/>&nbsp;<g:help code="systemAddressFormat.pattern"/></th>
            <th class="nowrap"><g:msg code="systemAddressFormat.joinBy" default="Join By"/>&nbsp;<g:help code="systemAddressFormat.joinBy"/></th>
        </tr>
        </thead>
        <tbody>
