...
<div class="dialog">
    <table>
        ...
        <tr class="prop">
            <td valign="top" class="name">
                <label for="lastLogin"><g:msg code="systemUser.lastLogin" default="Last Login"/>:</label>
            </td>
            <td valign="top" class="value ${hasErrors(bean: systemUserInstance, field: 'lastLogin', 'errors')}">
        ...
        <tr class="prop">
            <td valign="top" class="name">
                <label for="disabledUntil"><g:msg code="systemUser.disabledUntil" default="Disabled Until"/>:</label>
            </td>
            <td valign="top" class="value ${hasErrors(bean: systemUserInstance, field: 'disabledUntil', 'errors')}">
        ...
        <tr class="prop">
            <td valign="top" class="name">
                <label for="nextPasswordChange"><g:msg code="systemUser.nextPasswordChange" default="Next Password Change"/>:</label>
            </td>
            <td valign="top" class="value ${hasErrors(bean: systemUserInstance, field: 'nextPasswordChange', 'errors')}">
        ...
        <tr class="prop">
            <td valign="top" class="name">
                <label for="oldPassword1"><g:msg code="systemUser.oldPassword1" default="Old Password 1"/>:</label>
            </td>
            <td valign="top" class="value ${hasErrors(bean: systemUserInstance, field: 'oldPassword1', 'errors')}">
        ...
        <tr class="prop">
            <td valign="top" class="name">
                <label for="oldPassword2"><g:msg code="systemUser.oldPassword2" default="Old Password 2"/>:</label>
            </td>
            <td valign="top" class="value ${hasErrors(bean: systemUserInstance, field: 'oldPassword2', 'errors')}">
        ...
        <tr class="prop">
            <td valign="top" class="name">
                <label for="oldPassword3"><g:msg code="systemUser.oldPassword3" default="Old Password 3"/>:</label>
            </td>
            <td valign="top" class="value ${hasErrors(bean: systemUserInstance, field: 'oldPassword3', 'errors')}">
        ...
        <tr class="prop">
            <td valign="top" class="name">
                <label for="administrator"><g:msg code="systemUser.administrator" default="Administrator"/>:</label>
            </td>
            <td valign="top" class="value ${hasErrors(bean: systemUserInstance, field: 'administrator', 'errors')}">
        ...
        <tr class="prop">
            <td valign="top" class="name">
                <label for="disableHelp"><g:msg code="systemUser.disableHelp" default="Disable Help"/>:</label>
            </td>
