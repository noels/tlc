...
<head>
    ...
    <title><g:msg code="systemUser.create" default="Create User"/></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="systemUser.create" default="Create User"/>
    ...
    <g:form action="save" method="post">
        <g:render template="dialog" model="[systemUserInstance: systemUserInstance]"/>
        <div class="buttons">
