...
<head>
    ...
    <title><g:msg code="systemLanguage.edit" default="Edit System Language"/></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="systemLanguage.edit" default="Edit System Language"/>
    <g:if test="${flash.message}">
        <div class="message"><g:msg code="${flash.message}" args="${flash.args}" default="${flash.defaultMessage}"/></div>
    </g:if>
    <g:hasErrors bean="${systemLanguageInstance}">
        <div class="errors">
            <g:listErrors bean="${systemLanguageInstance}"/>
        </div>
    </g:hasErrors>
    <g:form method="post">
        <input type="hidden" name="id" value="${systemLanguageInstance?.id}"/>
        <input type="hidden" name="version" value="${systemLanguageInstance?.version}"/>
        <g:render template="dialog" model="[systemLanguageInstance: systemLanguageInstance]"/>
        <div class="buttons">
