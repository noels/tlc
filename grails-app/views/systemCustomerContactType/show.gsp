...
<head>
    ...
    <title><g:msg code="systemCustomerContactType.show" default="Show Customer Contact Type"/></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="systemCustomerContactType.show" default="Show Customer Contact Type"/>
        ...
        <table>
            ...
            <g:permit activity="sysadmin">
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${display(bean: systemCustomerContactTypeInstance, field: 'id')}</td>
            ...
            <tr class="prop">
                <td valign="top" class="name"><g:msg code="systemCustomerContactType.code" default="Code"/>:</td>

                <td valign="top" class="value">${display(bean: systemCustomerContactTypeInstance, field: 'code')}</td>
            ...
            <tr class="prop">
                <td valign="top" class="name"><g:msg code="systemCustomerContactType.name" default="Name"/>:</td>

                <td valign="top" class="value"><g:msg code="customerContactType.name.${systemCustomerContactTypeInstance.code}" default="${systemCustomerContactTypeInstance.name}"/></td>
            ...
            <g:permit activity="sysadmin">
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${display(bean: systemCustomerContactTypeInstance, field: 'securityCode')}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${display(bean: systemCustomerContactTypeInstance, field: 'dateCreated')}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${display(bean: systemCustomerContactTypeInstance, field: 'lastUpdated')}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${display(bean: systemCustomerContactTypeInstance, field: 'version')}</td>
