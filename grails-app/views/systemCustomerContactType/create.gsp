...
<head>
    ...
    <title><g:msg code="systemCustomerContactType.create" default="Create Customer Contact Type" /></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="systemCustomerContactType.create" default="Create Customer Contact Type"/>
