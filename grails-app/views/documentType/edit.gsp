...
<head>
    ...
    <title><g:msg code="documentType.edit" default="Edit Document Type" /></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="documentType.edit" default="Edit Document Type"/>
    <g:if test="${flash.message}">
        <div class="message"><g:msg code="${flash.message}" args="${flash.args}" default="${flash.defaultMessage}" /></div>
    </g:if>
    <g:hasErrors bean="${documentTypeInstance}">
        <div class="errors">
            <g:listErrors bean="${documentTypeInstance}" />
        </div>
    </g:hasErrors>
    <g:form method="post" >
        <input type="hidden" name="id" value="${documentTypeInstance?.id}" />
        <input type="hidden" name="version" value="${documentTypeInstance?.version}" />
        <g:render template="dialog" model="[documentTypeInstance: documentTypeInstance]" />
        <div class="buttons">
