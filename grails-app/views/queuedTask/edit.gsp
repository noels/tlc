...
<head>
    ...
    <title><g:msg code="queuedTask.edit" default="Edit Queued Task"/></title>
</head>
<body>
<div class="nav">
    <span class="menuButton"><a class="home" href="${createLink(uri: '/')}"><g:msg code="home" default="Home"/></a></span>
    <span class="menuButton"><g:link class="menu" controller="systemMenu" action="display"><g:msg code="systemMenu.display" default="Menu"/></g:link></span>
    <span class="menuButton"><g:link class="list" action="list"><g:msg code="queuedTask.list" default="Company Task Queue"/></g:link></span>
</div>
<div class="body">
    <g:pageTitle code="queuedTask.edit" default="Edit Queued Task"/>
    ...
    <g:form method="post">
        ...
        <g:render template="dialog" model="[queuedTaskInstance: queuedTaskInstance]"/>
        <div class="buttons">
