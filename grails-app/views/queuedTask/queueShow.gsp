...
<div class="body">
    ...
    <div class="dialog">
        <table>
            ...
            <tr class="prop">
                <td valign="top" class="name"><g:msg code="task.company" default="Company"/>:</td>

                <td valign="top" class="value">${queuedTaskInstance?.task?.company?.name?.encodeAsHTML()}</td>
            ...
            <tr class="prop">
                <td valign="top" class="name"><g:msg code="queuedTask.user" default="User"/>:</td>

                <td valign="top" class="value">${queuedTaskInstance?.user?.name?.encodeAsHTML()}</td>
        ...
        <g:if test="${queuedTaskInstance?.currentStatus == 'waiting'}">
            ...
            <g:form>
                ...
                <span class="button"><g:actionSubmit class="edit" action="queueEdit" value="${msg(code:'edit', 'default':'Edit')}"/></span>
