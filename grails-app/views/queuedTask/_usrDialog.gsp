    ...
    <table>
        ...
        <tr class="prop">
            ...
            <td valign="top" class="value ${hasErrors(bean: queuedTaskInstance, field: 'preferredStart', 'errors')}">
                <input initialField="true" type="text" size="20" id="preferredStart" name="preferredStart" value="${display(bean: queuedTaskInstance, field: 'preferredStart', scale: 2)}"/>&nbsp;<g:help code="queuedTask.preferredStart"/>
            </td>
        </tr>
