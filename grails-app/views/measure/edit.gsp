...
<head>
    ...
    <title><g:msg code="measure.edit" default="Edit Measure" /></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="measure.edit" default="Edit Measure" />
    <g:if test="${flash.message}">
        <div class="message"><g:msg code="${flash.message}" args="${flash.args}" default="${flash.defaultMessage}" /></div>
    </g:if>
    <g:hasErrors bean="${measureInstance}">
        <div class="errors">
            <g:listErrors bean="${measureInstance}" />
        </div>
    </g:hasErrors>
    <g:form method="post" >
        <input type="hidden" name="id" value="${measureInstance?.id}" />
        <input type="hidden" name="version" value="${measureInstance?.version}" />
        <g:render template="dialog" model="[measureInstance: measureInstance]" />
        <div class="buttons">
