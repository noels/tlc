...
<head>
    ...
    <title><g:msg code="accessGroup.edit" default="Edit Access Group" /></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="accessGroup.edit" default="Edit Access Group"/>
    <g:if test="${flash.message}">
        <div class="message"><g:msg code="${flash.message}" args="${flash.args}" default="${flash.defaultMessage}" /></div>
    </g:if>
    <g:hasErrors bean="${accessGroupInstance}">
        <div class="errors">
            <g:listErrors bean="${accessGroupInstance}" />
        </div>
    </g:hasErrors>
    <g:form method="post" >
        <input type="hidden" name="id" value="${accessGroupInstance?.id}" />
        <input type="hidden" name="version" value="${accessGroupInstance?.version}" />
        <g:render template="dialog" model="[accessGroupInstance: accessGroupInstance]" />
        <div class="buttons">
