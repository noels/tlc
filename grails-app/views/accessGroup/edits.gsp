...
<head>
    ...
    <title><g:msg code="accessGroup.edits" default="Edit Access Groups"/></title>
</head>
<body>
<div class="nav">
    <span class="menuButton"><a class="home" href="${createLink(uri: '/')}"><g:msg code="home" default="Home"/></a></span>
    <span class="menuButton"><g:link class="menu" controller="systemMenu" action="display"><g:msg code="systemMenu.display" default="Menu"/></g:link></span>
    <span class="menuButton"><g:link class="list" action="display"><g:msg code="accessGroup.list" default="Access Group List"/></g:link></span>
</div>
<div class="body">
    <g:pageTitle code="accessGroup.edits.for" args="${[ddSource.user.name]}" default="Edit Access Groups for User ${ddSource.user.name}"/>
    ...
    <g:form action="adjust" method="post">
        ...
        <div style="margin-left:30px;">
            <g:domainSelect name="linkages" options="${allGroups}" selected="${userGroups}" displays="name" size="30"/>
        </div>
        <div class="buttons">
