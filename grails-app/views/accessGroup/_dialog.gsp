    ...
    <table>
        ...
        <tr class="prop">
            <td valign="top" class="name">
                <label for="code"><g:msg code="accessGroup.code" default="Code"/>:</label>
            </td>
            <td valign="top" class="value ${hasErrors(bean: accessGroupInstance, field: 'code', 'errors')}">
                <input initialField="true" type="text" maxlength="10" size="10" id="code" name="code" value="${display(bean: accessGroupInstance, field: 'code')}"/>&nbsp;<g:help code="accessGroup.code"/>
            </td>
        </tr>

        <tr class="prop">
            <td valign="top" class="name">
                <label for="name"><g:msg code="accessGroup.name" default="Name"/>:</label>
            </td>
            <td valign="top" class="value ${hasErrors(bean: accessGroupInstance, field: 'name', 'errors')}">
        ...
        <g:if test="${elementList[0]}">
            <tr class="prop">
                ...
                <td valign="top" class="value ${hasErrors(bean: accessGroupInstance, field: 'element1', 'errors')}">
        ...
        <g:if test="${elementList[1]}">
            <tr class="prop">
                ...
                <td valign="top" class="value ${hasErrors(bean: accessGroupInstance, field: 'element2', 'errors')}">
        ...
        <g:if test="${elementList[2]}">
            <tr class="prop">
                ...
                <td valign="top" class="value ${hasErrors(bean: accessGroupInstance, field: 'element3', 'errors')}">
        ...
        <g:if test="${elementList[3]}">
            <tr class="prop">
                ...
                <td valign="top" class="value ${hasErrors(bean: accessGroupInstance, field: 'element4', 'errors')}">
        ...
        <g:if test="${elementList[4]}">
            <tr class="prop">
                ...
                <td valign="top" class="value ${hasErrors(bean: accessGroupInstance, field: 'element5', 'errors')}">
        ...
        <g:if test="${elementList[5]}">
            <tr class="prop">
                ...
                <td valign="top" class="value ${hasErrors(bean: accessGroupInstance, field: 'element6', 'errors')}">
        ...
        <g:if test="${elementList[6]}">
            <tr class="prop">
                ...
                <td valign="top" class="value ${hasErrors(bean: accessGroupInstance, field: 'element7', 'errors')}">
        ...
        <g:if test="${elementList[7]}">
            <tr class="prop">
                ...
                <td valign="top" class="value ${hasErrors(bean: accessGroupInstance, field: 'element8', 'errors')}">
        ...
        <tr class="prop">
            <td valign="top" class="name">
                <label for="customers"><g:msg code="accessGroup.customers" default="Customers"/>:</label>
            </td>
            <td valign="top" class="value ${hasErrors(bean: accessGroupInstance, field: 'customers', 'errors')}">
        ...
        <tr class="prop">
            <td valign="top" class="name">
                <label for="suppliers"><g:msg code="accessGroup.suppliers" default="Suppliers"/>:</label>
            </td>
            <td valign="top" class="value ${hasErrors(bean: accessGroupInstance, field: 'suppliers', 'errors')}">
