...
<head>
    ...
    <title><g:msg code="scale.show" default="Show Scale" /></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="scale.show" default="Show Scale" />
    ...
    <div class="dialog">
        <table>
            ...
            <tr class="prop">
                ...
                <td valign="top" class="value">${display(bean:scaleInstance, field:'id')}</td>
            ...
            <tr class="prop">
                <td valign="top" class="name"><g:msg code="scale.code" default="Code" />:</td>

                <td valign="top" class="value">${display(bean:scaleInstance, field:'code')}</td>
            ...
            <tr class="prop">
                <td valign="top" class="name"><g:msg code="scale.name" default="Name" />:</td>

                <td valign="top" class="value"><g:msg code="scale.name.${scaleInstance.code}" default="${scaleInstance.name}"/></td>
            ...
            <tr class="prop">
                ...
                <td valign="top" class="value">${display(bean:scaleInstance, field:'securityCode')}</td>
            ...
            <tr class="prop">
                ...
                <td valign="top" class="value">${display(bean:scaleInstance, field:'dateCreated')}</td>
            ...
            <tr class="prop">
                ...
                <td valign="top" class="value">${display(bean:scaleInstance, field:'lastUpdated')}</td>
            ...
            <tr class="prop">
                ...
                <td valign="top" class="value">${display(bean:scaleInstance, field:'version')}</td>
