...
<head>
    ...
    <title><g:msg code="taxStatement.show" default="Show Tax Statement"/></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="taxStatement.show" default="Show Tax Statement"/>
        ...
        <table>
            ...
            <g:permit activity="sysadmin">
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${display(bean: taxStatementInstance, field: 'id')}</td>
            ...
            <tr class="prop">
                ...
                <g:if test="${taxStatementInstance.finalized}">
                    <td valign="top" class="value">${taxStatementInstance.document ? (taxStatementInstance.document.type.code + taxStatementInstance.document.code).encodeAsHTML() : msg(code: 'generic.not.applicable', default: 'n/a')}</td>
                </g:if>
                <g:else>
            ...
            <g:permit activity="sysadmin">
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${display(bean: taxStatementInstance, field: 'securityCode')}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${display(bean: taxStatementInstance, field: 'dateCreated')}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${display(bean: taxStatementInstance, field: 'lastUpdated')}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${display(bean: taxStatementInstance, field: 'version')}</td>
