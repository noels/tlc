...
<head>
    ...
    <title><g:msg code="systemAccountType.edit" default="Edit System Account Type" /></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="systemAccountType.edit" default="Edit System Account Type"/>
    ...
    <g:form method="post" >
        ...
        <input type="hidden" name="version" value="${systemAccountTypeInstance?.version}" />
