...
<head>
    ...
    <title><g:msg code="taskResult.edit" default="Edit Task Result"/></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="taskResult.edit" default="Edit Task Result"/>
    <g:if test="${flash.message}">
        <div class="message"><g:msg code="${flash.message}" args="${flash.args}" default="${flash.defaultMessage}"/></div>
    </g:if>
    <g:hasErrors bean="${taskResultInstance}">
        <div class="errors">
            <g:listErrors bean="${taskResultInstance}"/>
        </div>
    </g:hasErrors>
    <g:form method="post">
        <input type="hidden" name="id" value="${taskResultInstance?.id}"/>
        <input type="hidden" name="version" value="${taskResultInstance?.version}"/>
        <g:render template="dialog" model="[taskResultInstance: taskResultInstance]"/>
        <div class="buttons">
