...
<head>
    ...
    <title><g:msg code="exchangeCurrency.edit" default="Edit Currency" /></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="exchangeCurrency.edit" default="Edit Currency" />
    ...
    <g:form method="post" >
        ...
        <input type="hidden" name="version" value="${exchangeCurrencyInstance?.version}" />
        <g:render template="dialog" model="[exchangeCurrencyInstance: exchangeCurrencyInstance]" />
        <div class="buttons">
