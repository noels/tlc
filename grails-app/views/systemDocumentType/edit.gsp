...
<head>
    ...
    <title><g:msg code="systemDocumentType.edit" default="Edit System Document Type" /></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="systemDocumentType.edit" default="Edit System Document Type"/>
    <g:if test="${flash.message}">
        <div class="message"><g:msg code="${flash.message}" args="${flash.args}" default="${flash.defaultMessage}" /></div>
    </g:if>
    <g:hasErrors bean="${systemDocumentTypeInstance}">
        <div class="errors">
            <g:listErrors bean="${systemDocumentTypeInstance}" />
        </div>
    </g:hasErrors>
    <g:form method="post" >
        <input type="hidden" name="id" value="${systemDocumentTypeInstance?.id}" />
        <input type="hidden" name="version" value="${systemDocumentTypeInstance?.version}" />
        <g:render template="dialog" model="[systemDocumentTypeInstance: systemDocumentTypeInstance]" />
        <div class="buttons">
