...
<head>
    ...
    <title><g:msg code="taskParam.edit" default="Edit Task Parameter"/></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="taskParam.edit" default="Edit Task Parameter"/>
    <g:if test="${flash.message}">
        <div class="message"><g:msg code="${flash.message}" args="${flash.args}" default="${flash.defaultMessage}"/></div>
    </g:if>
    <g:hasErrors bean="${taskParamInstance}">
        <div class="errors">
            <g:listErrors bean="${taskParamInstance}"/>
        </div>
    </g:hasErrors>
    <g:form method="post">
        <input type="hidden" name="id" value="${taskParamInstance?.id}"/>
        <input type="hidden" name="version" value="${taskParamInstance?.version}"/>
        <g:render template="dialog" model="[taskParamInstance: taskParamInstance]"/>
        <div class="buttons">
