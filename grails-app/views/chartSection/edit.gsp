...
<head>
    ...
    <title><g:msg code="chartSection.edit" default="Edit Chart Section" /></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="chartSection.edit" default="Edit Chart Section"/>
    ...
    <g:form method="post" >
        ...
        <input type="hidden" name="version" value="${chartSectionInstance?.version}" />
        <g:render template="dialog" model="[chartSectionInstance: chartSectionInstance]" />
        <div class="buttons">
