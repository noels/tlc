    ...
    <table>
        ...
        <tr class="prop">
            <td valign="top" class="name">
                <label for="path"><g:msg code="chartSection.path" default="Path"/>:</label>
            </td>
            <td valign="top" class="value ${hasErrors(bean: chartSectionInstance, field: 'path', 'errors')}">
                <input initialField="true" type="text" maxlength="99" size="30" id="path" name="path" value="${display(bean: chartSectionInstance, field: 'path')}"/>&nbsp;<g:help code="chartSection.path"/>
            </td>
        </tr>

        <tr class="prop">
            <td valign="top" class="name">
                <label for="name"><g:msg code="chartSection.name" default="Name"/>:</label>
            </td>
            <td valign="top" class="value ${hasErrors(bean: chartSectionInstance, field: 'name', 'errors')}">
        ...
        <tr class="prop">
            <td valign="top" class="name">
                <label for="sequencer"><g:msg code="chartSection.sequencer" default="Sequencer"/>:</label>
            </td>
            <td valign="top" class="value ${hasErrors(bean: chartSectionInstance, field: 'sequencer', 'errors')}">
        ...
        <tr class="prop">
            <td valign="top" class="name">
                <label for="type"><g:msg code="chartSection.type" default="Type"/>:</label>
            </td>
            <td valign="top" class="value ${hasErrors(bean: chartSectionInstance, field: 'type', 'errors')}">
        ...
        <tr class="prop">
            <td valign="top" class="name">
                <label for="status"><g:msg code="chartSection.status" default="Status"/>:</label>
            </td>
            <td valign="top" class="value ${hasErrors(bean: chartSectionInstance, field: 'status', 'errors')}">
        ...
        <tr class="prop">
            <td valign="top" class="name">
                <label for="autoCreate"><g:msg code="chartSection.autoCreate" default="Auto Create"/>:</label>
            </td>
            <td valign="top" class="value ${hasErrors(bean: chartSectionInstance, field: 'autoCreate', 'errors')}">
            ...
            <td colspan="2">
                <table style="border:0px;">
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top" class="name" style="font-weight:bold;"><g:msg code="chartSection.segments" default="Segments"/>&nbsp;<g:help code="chartSection.segments"/></td>
                        <td valign="top" class="name" style="font-weight:bold;"><g:msg code="chartSection.defaults" default="Defaults"/>&nbsp;<g:help code="chartSection.defaults"/></td>
                    </tr>
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top" class="value ${hasErrors(bean: chartSectionInstance, field: 'segment1', 'errors')}">
                        ...
                        <td valign="top" class="value ${hasErrors(bean: chartSectionInstance, field: 'default1', 'errors')}">
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top" class="value ${hasErrors(bean: chartSectionInstance, field: 'segment2', 'errors')}">
                        ...
                        <td valign="top" class="value ${hasErrors(bean: chartSectionInstance, field: 'default2', 'errors')}">
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top" class="value ${hasErrors(bean: chartSectionInstance, field: 'segment3', 'errors')}">
                        ...
                        <td valign="top" class="value ${hasErrors(bean: chartSectionInstance, field: 'default3', 'errors')}">
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top" class="value ${hasErrors(bean: chartSectionInstance, field: 'segment4', 'errors')}">
                        ...
                        <td valign="top" class="value ${hasErrors(bean: chartSectionInstance, field: 'default4', 'errors')}">
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top" class="value ${hasErrors(bean: chartSectionInstance, field: 'segment5', 'errors')}">
                        ...
                        <td valign="top" class="value ${hasErrors(bean: chartSectionInstance, field: 'default5', 'errors')}">
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top" class="value ${hasErrors(bean: chartSectionInstance, field: 'segment6', 'errors')}">
                        ...
                        <td valign="top" class="value ${hasErrors(bean: chartSectionInstance, field: 'default6', 'errors')}">
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top" class="value ${hasErrors(bean: chartSectionInstance, field: 'segment7', 'errors')}">
                        ...
                        <td valign="top" class="value ${hasErrors(bean: chartSectionInstance, field: 'default7', 'errors')}">
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top" class="value ${hasErrors(bean: chartSectionInstance, field: 'segment8', 'errors')}">
                        ...
                        <td valign="top" class="value ${hasErrors(bean: chartSectionInstance, field: 'default8', 'errors')}">
