        ...
        <table>
            ...
            <g:each in="${queuedTaskResultInstanceList}" status="i" var="queuedTaskResultInstance">
                <tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
                    ...
                    <td><g:link action="show" id="${queuedTaskResultInstance.id}"><g:msg code="taskResult.name.${queuedTaskResultInstance.result.code}" default="${queuedTaskResultInstance.result.name}"/></g:link></td>
