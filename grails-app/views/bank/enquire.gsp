...
<head>
    ...
    <title><g:msg code="bank.enquire" default="Bank Payment/Receipt Enquiry"/></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="bank.enquire" default="Bank Payment/Receipt Enquiry" help="document.enquire"/>
        ...
        <div class="dialog">
            <table>
                ...
                <g:if test="${documentInstance.id}">
                    <tr class="prop">
                        <td valign="top" class="name"><g:msg code="bank.account" default="Bank Account"/>:</td>
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top" colspan="3" class="value">${display(bean: documentInstance, field: 'description')}</td>

                        <td valign="top" class="name"><g:msg code="document.journal.reference" default="Reference"/>:</td>
                        <td valign="top" colspan="3" class="value">${display(bean: documentInstance, field: 'reference')}</td>
                    </tr>
                </g:if>
                </tbody>
            </table>
        ...
        <div class="list">
            <table>
                ...
                <tr>
                    ...
                    <th class="right"><g:msg code="document.amount" default="Value"/></th>
                </tr>
                </thead>
                <tbody>
