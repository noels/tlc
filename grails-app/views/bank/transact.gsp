            ...
            <table>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="sourceCode"><g:msg code="bank.account" default="Bank Account"/>:</label>
                    </td>
                    <td valign="top" class="small-value ${hasErrors(bean: documentInstance, field: 'sourceCode', 'errors')}">
                        <g:select initialField="true" onchange="accountChanged()" onblur="getBank(this, '${createLink(controller: 'document', action: 'bank')}', 'bank')" optionKey="code" optionValue="name" from="${bankAccountList}" name="sourceCode" value="${documentInstance?.sourceCode}" noSelection="['': msg(code: 'generic.select', default: '-- select --')]"/>&nbsp;<g:help code="bank.account"/>
                    </td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="name">
                        <label for="sourceTotal"><g:msg code="bank.total" default="Total"/>:</label>
                    </td>
        ...
        <div class="list entry">
            <table>
                ...
                <tr>
                    ...
                    <th><g:msg code="document.amount" default="Value"/></th>
                </tr>
                </thead>
                <tbody>
                <g:each in="${documentInstance.lines}" status="i" var="documentLine">
                    ...
                    <tr>
                        <td class="narrow" colspan="3" style="padding-bottom:12px;"><input disabled="true" type="text" size="76" id="lines[${i}].displayName" name="lines[${i}].displayName" value="${display(bean: documentLine, field: 'accountName')}"/></td>
