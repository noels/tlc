    ...
    <table>
        ...
        <tr class="prop">
            <td valign="top" class="name">
                <label for="sourceCode"><g:msg code="templateDocument.bank" default="Bank Account"/>:</label>
            </td>
...
<div class="list entry">
    <table>
        ...
        <tr>
            ...
            <th><g:msg code="document.amount" default="Value"/>&nbsp;<g:help code="document.amount"/></th>
        </tr>
        </thead>
        <tbody>
