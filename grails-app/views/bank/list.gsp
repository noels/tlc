...
<head>
    ...
    <title><g:msg code="templateDocument.bank.list" default="Bank Payment/Receipt Template List" /></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="templateDocument.bank.list" default="Bank Payment/Receipt Template List"/>
