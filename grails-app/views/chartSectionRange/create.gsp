...
<head>
    ...
    <title><g:msg code="chartSectionRange.create" default="Create Chart Section Range" /></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="chartSectionRange.create" default="Create Chart Section Range"/>
