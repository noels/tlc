...
<head>
    ...
    <title><g:msg code="customer.print" default="Customer List Report"/></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="customer.print" default="Customer List Report"/>
        ...
        <g:form action="printing" method="post">
            <div class="dialog">
                <table>
                    ...
                    <tr class="prop">
                        <td valign="top" class="name">
                            <label for="active"><g:msg code="report.active" default="Active Only"/>:</label>
                        </td>
                        <td valign="top" class="value ${hasErrors(bean: customerInstance, field: 'active', 'errors')}">
                            <g:checkBox name="active" value="${customerInstance?.active}"></g:checkBox>&nbsp;<g:help code="report.active"/>
                        </td>
                    </tr>
