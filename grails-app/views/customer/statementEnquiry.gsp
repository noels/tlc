            ...
            <div class="dialog">
                <table>
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top" class="value"><g:enquiryLink target="${customerInstance}" displayPeriod="${displayPeriod}" displayCurrency="${displayCurrency}">${customerInstance.code.encodeAsHTML()}</g:enquiryLink>&nbsp;${customerInstance.name.encodeAsHTML()}</td>

                        <td valign="top" class="name"><g:msg code="document.currency" default="Currency"/>:</td>
                        <td valign="top" class="value">${customerInstance.currency.code.encodeAsHTML()}</td>

                        <td valign="top" class="name">
                            <label for="statement"><g:msg code="customer.statement.enquire.date" default="Statement"/>:</label>
                        </td>
                ...
                <table>
                    ...
                    <g:each in="${statementLineInstanceList}" status="i" var="statementLineInstance">
                        ...
                        <g:elseif test="${statementLineInstance.currentStatement != statementLineInstanceList[i - 1].currentStatement}">
                            <tr>
                                <td colspan="8" style="font-style:italic;"><g:msg code="customer.statement.current" default="New Items"/></td>
                            </tr>
                        </g:elseif>
                    ...
                    <tr>
                        <td colspan="5" class="right" style="font-weight:bold;"><g:msg code="document.docTotal" default="Total"/></td>
                        <td class="right" style="font-weight:bold;">${format(value: due + overdue, scale: customerInstance.currency.decimals, locale: locale)}</td>
                        <td colspan="2"></td>
                    </tr>
                    </tbody>
                </table>
