...
<head>
    ...
    <title><g:msg code="customer.statements" default="Customer Statements"/></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="customer.statements" default="Customer Statements"/>
    <g:if test="${accessCodeList}">
        ...
        <g:form action="statement" method="post">
            <div class="dialog">
                <table>
                    <tbody>
                    <tr class="prop">
                        <td valign="top" class="name">
                            <label for="taxId"><g:msg code="customer.statement.customer" default="Specific Customer" />:</label>
                        </td>
                    ...
                    <tr class="prop">
                        <td valign="top" class="name">
                            <label for="statementDate"><g:msg code="customer.statements.date" default="Statement Date" />:</label>
                        </td>
                        <td valign="top" class="value ${hasErrors(bean:customerInstance,field:'dateCreated','errors')}">
                            <input type="text" size="20" id="statementDate" name="statementDate" value="${statementDate?.encodeAsHTML()}"/>&nbsp;<g:help code="customer.statements.date"/>
                        </td>
                    </tr>
