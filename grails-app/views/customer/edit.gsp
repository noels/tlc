...
<head>
    ...
    <title><g:msg code="customer.edit" default="Edit Customer"/></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="customer.edit" default="Edit Customer"/>
    ...
    <g:form method="post">
        ...
        <input type="hidden" name="version" value="${customerInstance?.version}"/>
        <g:render template="dialog" model="[customerInstance: customerInstance]"/>
        <div class="buttons">
