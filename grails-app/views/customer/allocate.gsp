...
<div class="body">
    <g:pageTitle code="sales.manual" default="Manual Allocation" help="maintenance.allocation" returns="true" params="${[displayPeriod: transactionPeriod]}"/>
    ...
    <g:form method="post">
        <input type="hidden" name="transactionPeriod" value="${transactionPeriod}"/>
        <div class="dialog">
            <table>
                <tbody>
                <tr class="prop">
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value nowrap" colspan="3">${display(bean: customerInstance, field: 'name')}</td>

                    <td valign="top" class="name"><g:msg code="document.currency" default="Currency"/>:</td>
                    <td valign="top" class="value" colspan="2">${msg(code: 'currency.name.' + customerInstance.currency.code, default: customerInstance.currency.name)}</td>
                </tr>
                </tbody>
            </table>
    ...
    <div class="paginateButtons">
        <g:paginate total="${transactionInstanceTotal}" action="allocate" id="${lineInstance.id}" params="${[displayPeriod: displayPeriod?.id, 'targetType.id': allocationInstance.targetType?.id, targetCode: allocationInstance.targetCode, accountValue: allocationInstance.accountValue, transactionPeriod: transactionPeriod]}"/>
    </div>
</div>
</body>
</html>
