...
<head>
    ...
    <title><g:msg code="receivable.journal.entry" default="Accounts Receivable Journal Entry"/></title>
...
<div class="nav">
    ...
    <span class="menuButton"><g:link class="list" controller="document" action="templates" params="${[ctrl: 'receivable', types: 'ARJ']}"><g:msg code="templateDocument.load" default="Load Template"/></g:link></span>
</div>
<div class="body">
    <g:pageTitle code="receivable.journal.entry" default="Accounts Receivable Journal Entry"/>
    ...
    <g:form method="post">
        ...
        <div class="list entry">
            <table>
                <thead>
                <tr>
                    <th><g:msg code="document.customer" default="Customer"/>&nbsp;<g:help code="document.customer"/></th>
