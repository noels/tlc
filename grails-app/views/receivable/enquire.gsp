...
<head>
    ...
    <title><g:msg code="receivable.journal.enquire" default="Accounts Receivable Journal Enquiry"/></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="receivable.journal.enquire" default="Accounts Receivable Journal Enquiry" help="document.enquire"/>
    ...
    <g:if test="${documentInstance.id}">
        <div class="list">
            <table>
                <thead>
                <tr>
                    <th><g:msg code="document.customer" default="Customer"/></th>
