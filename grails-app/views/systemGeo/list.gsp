...
<head>
    ...
    <title><g:msg code="systemGeo.list" default="System Geo List"/></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="systemGeo.list" default="System Geo List"/>
    ...
    <div class="list">
        <table>
            ...
            <tr>
                ...
                <g:sortableColumn property="code" title="Code" titleKey="systemGeo.code"/>

                <th><g:msg code="systemGeo.name" default="Name"/></th>

                <th><g:msg code="systemGeo.regions" default="Regions"/></th>
