...
<head>
    ...
    <title><g:msg code="systemGeo.edit" default="Edit System Geo"/></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="systemGeo.edit" default="Edit System Geo"/>
    ...
    <g:form method="post">
        ...
        <input type="hidden" name="version" value="${systemGeoInstance?.version}"/>
