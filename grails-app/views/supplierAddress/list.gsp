...
<head>
    ...
    <title><g:msg code="supplierAddress.list" default="Supplier Address List"/></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="supplierAddress.list.for" args="${[ddSource?.name]}" default="Supplier Address List for ${ddSource?.name}" returns="true"/>
    ...
    <div class="list">
        <table>
            ...
            <tr>
                ...
                <th><g:msg code="supplierAddress.addressUsages" default="Usages"/></th>
                <th><g:msg code="supplierAddress.contacts" default="Contacts"/></th>
            </tr>
            </thead>
            <tbody>
