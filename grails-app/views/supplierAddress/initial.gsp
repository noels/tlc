...
<div class="nav">
    ...
    <span class="menuButton"><g:link class="list" controller="supplier" action="show" id="${supplierAddressInstance.supplier.id}"><g:msg code="supplierAddress.supplier" default="Supplier" /></g:link></span>
</div>
<div class="body">
    ...
    <g:form name="jsform" action="initializing" method="post" >
        ...
        <g:render template="dialog" model="[supplierAddressInstance: supplierAddressInstance]" />
        <div class="buttons">
