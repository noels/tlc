            ...
            <table>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="sourceCode"><g:msg code="document.supplier" default="Supplier"/>:</label>
                    </td>
                    <td valign="top" class="small-value ${hasErrors(bean: documentInstance, field: 'sourceCode', 'errors')}">
                        <input initialField="true" onchange="getLedger(this, '${createLink(controller: 'document', action: 'supplier')}')" type="text" maxlength="20" size="20" id="sourceCode" name="sourceCode" value="${display(bean: documentInstance, field: 'sourceCode')}"/>&nbsp;<g:help code="document.supplier"/>
                    </td>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="reference"><g:msg code="document.supplier.reference" default="Reference"/>:</label>
                    </td>
