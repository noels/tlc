...
<head>
    ...
    <title><g:msg code="templateDocument.pi.list" default="Purchase Invoice/Cr. Note Template List" /></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="templateDocument.pi.list" default="Purchase Invoice/Cr. Note Template List"/>
