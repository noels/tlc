...
<head>
    ...
    <title><g:msg code="purchase.invoice.enquire" default="Purchase Invoice/Cr. Note Enquiry"/></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="purchase.invoice.enquire" default="Purchase Invoice/Cr. Note Enquiry" help="document.enquire"/>
            ...
            <table>
                ...
                <g:if test="${documentInstance.id}">
                    <tr class="prop">
                        ...
                        <td valign="top" class="value" colspan="3"><g:enquiryLink target="${supplierInstance}" displayPeriod="${documentInstance.period}" displayCurrency="${displayCurrency}">${supplierInstance.code.encodeAsHTML()}</g:enquiryLink>&nbsp;${supplierInstance.name.encodeAsHTML()}</td>
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top" class="name"><g:msg code="document.due" default="Due"/>:</td>
                        <td valign="top" class="value">${display(bean: documentInstance, field: 'dueDate', scale: 1)}</td>

                        <td valign="top" class="name"><g:msg code="document.supplier.reference" default="Reference"/>:</td>
                    ...
                    <tr class="prop">
                        ...
                        <td valign="top" class="value" colspan="3">${display(bean: documentInstance, field: 'description')}</td>
                        ...
                        <td valign="top" class="name"><g:msg code="generalTransaction.accountUnallocated" default="Unallocated"/>:</td>
                        <td valign="top" class="value nowrap"><g:enquiryLink target="${totalInstance}" displayPeriod="${displayPeriod}" displayCurrency="${displayCurrency}"><g:drcr context="${documentInstance}" line="${totalInstance}" field="unallocated" currency="${displayCurrency}" zeroIsUnmarked="true"/></g:enquiryLink></td>
                    </tr>
                </g:if>
                </tbody>
            </table>
