...
<head>
    ...
    <title><g:msg code="codeElementValue.show" default="Show Code Element Value"/></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="codeElementValue.show" default="Show Code Element Value"/>
        ...
        <table>
            ...
            <g:permit activity="sysadmin">
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${display(bean: codeElementValueInstance, field: 'id')}</td>
            ...
            <tr class="prop">
                <td valign="top" class="name"><g:msg code="codeElementValue.code" default="Code"/>:</td>

                <td valign="top" class="value">${display(bean: codeElementValueInstance, field: 'code')}</td>
            ...
            <tr class="prop">
                <td valign="top" class="name"><g:msg code="codeElementValue.shortName" default="Short Name"/>:</td>

                <td valign="top" class="value">${display(bean: codeElementValueInstance, field: 'shortName')}</td>
            ...
            <tr class="prop">
                <td valign="top" class="name"><g:msg code="codeElementValue.name" default="Name"/>:</td>

                <td valign="top" class="value">${display(bean: codeElementValueInstance, field: 'name')}</td>
            ...
            <g:permit activity="sysadmin">
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${display(bean: codeElementValueInstance, field: 'securityCode')}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${display(bean: codeElementValueInstance, field: 'dateCreated')}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${display(bean: codeElementValueInstance, field: 'lastUpdated')}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${display(bean: codeElementValueInstance, field: 'version')}</td>
