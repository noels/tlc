...
<head>
    ...
    <title><g:msg code="companyUser.edit" default="Edit Company User"/></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="companyUser.edit" default="Edit Company User"/>
    ...
    <g:form method="post">
        ...
        <input type="hidden" name="version" value="${companyUserInstance?.version}"/>
        <g:render template="dialog" model="[companyUserInstance: companyUserInstance]"/>
        <div class="buttons">
