...
<head>
    ...
    <title><g:msg code="taxRate.edit" default="Edit Tax Rate"/></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="taxRate.edit" default="Edit Tax Rate"/>
    ...
    <g:form method="post">
        ...
        <g:render template="dialog" model="[taxRateInstance: taxRateInstance]"/>
        <div class="buttons">
