...
<head>
    ...
    <title><g:msg code="year.show" default="Show Year" /></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="year.show" default="Show Year"/>
    ...
    <div class="dialog">
        <table>
            ...
            <tr class="prop">
                ...
                <td valign="top" class="value">${display(bean:yearInstance, field:'id')}</td>
            ...
            <tr class="prop">
                <td valign="top" class="name"><g:msg code="year.code" default="Code" />:</td>

                <td valign="top" class="value">${display(bean:yearInstance, field:'code')}</td>
            ...
            <tr class="prop">
                <td valign="top" class="name"><g:msg code="year.validFrom" default="Valid From" />:</td>

                <td valign="top" class="value">${display(bean:yearInstance, field:'validFrom', scale: 1)}</td>
            ...
            <tr class="prop">
                <td valign="top" class="name"><g:msg code="year.validTo" default="Valid To" />:</td>

                <td valign="top" class="value">${display(bean:yearInstance, field:'validTo', scale: 1)}</td>
            ...
            <tr class="prop">
                ...
                <td valign="top" class="value">${display(bean:yearInstance, field:'securityCode')}</td>
            ...
            <tr class="prop">
                ...
                <td valign="top" class="value">${display(bean:yearInstance, field:'dateCreated')}</td>
            ...
            <tr class="prop">
                ...
                <td valign="top" class="value">${display(bean:yearInstance, field:'lastUpdated')}</td>
            ...
            <tr class="prop">
                ...
                <td valign="top" class="value">${display(bean:yearInstance, field:'version')}</td>
