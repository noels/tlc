...
<head>
    ...
    <title><g:msg code="year.edit" default="Edit Year" /></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="year.edit" default="Edit Year"/>
    ...
    <g:form method="post" >
        ...
        <input type="hidden" name="version" value="${yearInstance?.version}" />
