...
<head>
    ...
    <title><g:msg code="systemActivity.links" args="${[message(code: 'systemRole.name.' + ddSource.code, default: ddSource.name)]}" default="Define Activities for System Role ${msg(code: 'systemRole.name.' + ddSource.code, default: ddSource.name)}"/></title>
</head>
<body>
<div class="nav">
