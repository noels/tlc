...
<head>
    ...
    <title><g:msg code="customerAddress.show" default="Show Customer Address"/></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="customerAddress.show" default="Show Customer Address"/>
        ...
        <table>
            ...
            <g:permit activity="sysadmin">
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${display(bean: customerAddressInstance, field: 'id')}</td>
            ...
            <g:each in="${customerAddressLines}" status="i" var="customerAddressLine">
                <tr>
                    <td valign="top" class="name">${customerAddressLine.label?.encodeAsHTML()}:</td>

                    <td valign="top" class="value">${customerAddressLine.value?.encodeAsHTML()}</td>
                </tr>
            </g:each>
                <tr>
                    <td valign="top" class="name"><g:msg code="customerAddress.addressUsages" default="Usages"/>:</td>
            ...
            <g:permit activity="sysadmin">
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${display(bean: customerAddressInstance, field: 'securityCode')}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${display(bean: customerAddressInstance, field: 'dateCreated')}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${display(bean: customerAddressInstance, field: 'lastUpdated')}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${display(bean: customerAddressInstance, field: 'version')}</td>
