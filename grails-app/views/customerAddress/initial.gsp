...
<div class="nav">
    ...
    <span class="menuButton"><g:link class="list" controller="customer" action="show" id="${customerAddressInstance.customer.id}"><g:msg code="customerAddress.customer" default="Customer" /></g:link></span>
</div>
<div class="body">
    <g:pageTitle code="customerAddress.initial" args="${[customerAddressInstance.customer.name]}" default="Initial Customer Address for ${customerAddressInstance.customer.name}"/>
    ...
    <g:form name="jsform" action="initializing" method="post" >
        <input type="hidden" name="parent" value="${customerAddressInstance.customer.id}" />
        ...
        <g:render template="dialog" model="[customerAddressInstance: customerAddressInstance]" />
        <div class="buttons">
