...
<head>
    ...
    <title><g:msg code="systemRegion.edit" default="Edit System Region"/></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="systemRegion.edit" default="Edit System Region"/>
    <g:if test="${flash.message}">
        <div class="message"><g:msg code="${flash.message}" args="${flash.args}" default="${flash.defaultMessage}"/></div>
    </g:if>
    <g:hasErrors bean="${systemRegionInstance}">
        <div class="errors">
            <g:listErrors bean="${systemRegionInstance}"/>
        </div>
    </g:hasErrors>
    <g:form method="post">
        <input type="hidden" name="id" value="${systemRegionInstance?.id}"/>
        <input type="hidden" name="version" value="${systemRegionInstance?.version}"/>
        <g:render template="dialog" model="[systemRegionInstance: systemRegionInstance, ddSource: ddSource]"/>
        <div class="buttons">
