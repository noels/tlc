...
<head>
    ...
    <title><g:msg code="templateDocument.provn.list" default="Accrual/Prepayment Template List" /></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="templateDocument.provn.list" default="Accrual/Prepayment Template List"/>
