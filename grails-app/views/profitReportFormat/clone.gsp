            ...
            <table>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value ${hasErrors(bean: profitReportFormatInstance, field: 'name', 'errors')}">
                        <input initialField="true" type="text" maxlength="30" size="30" id="name" name="name" value="${display(bean: profitReportFormatInstance, field: 'name')}"/>&nbsp;<g:help code="profitReportFormat.name"/>
                    </td>
                </tr>
                </tbody>
            </table>
