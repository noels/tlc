...
<head>
    ...
    <title><g:msg code="setting.edit" default="Edit Setting" /></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="setting.edit" default="Edit Setting"/>
    <g:if test="${flash.message}">
        <div class="message"><g:msg code="${flash.message}" args="${flash.args}" default="${flash.defaultMessage}" /></div>
    </g:if>
    <g:hasErrors bean="${settingInstance}">
        <div class="errors">
            <g:listErrors bean="${settingInstance}" />
        </div>
    </g:hasErrors>
    <g:form method="post" >
        <input type="hidden" name="id" value="${settingInstance?.id}" />
        <input type="hidden" name="version" value="${settingInstance?.version}" />
        <g:render template="dialog" model="[settingInstance: settingInstance]" />
        <div class="buttons">
