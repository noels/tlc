...
<head>
    ...
    <title><g:msg code="systemPaymentSchedule.edit" default="Edit System Payment Schedule" /></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="systemPaymentSchedule.edit" default="Edit System Payment Schedule"/>
    ...
    <g:form method="post" >
        ...
        <input type="hidden" name="version" value="${systemPaymentScheduleInstance?.version}" />
        <g:render template="dialog" model="[systemPaymentScheduleInstance: systemPaymentScheduleInstance]" />
        <div class="buttons">
