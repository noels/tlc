...
<head>
    ...
    <title><g:msg code="systemPaymentSchedule.create" default="Create System Payment Schedule" /></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="systemPaymentSchedule.create" default="Create System Payment Schedule"/>
