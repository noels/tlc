...
<head>
    ...
    <title><g:msg code="systemMenu.edit" default="Edit Menu Option"/></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="systemMenu.edit" default="Edit Menu Option"/>
    <g:if test="${flash.message}">
        <div class="message"><g:msg code="${flash.message}" args="${flash.args}" default="${flash.defaultMessage}"/></div>
    </g:if>
    <g:hasErrors bean="${systemMenuInstance}">
        <div class="errors">
            <g:listErrors bean="${systemMenuInstance}"/>
        </div>
    </g:hasErrors>
    <g:form method="post">
        <input type="hidden" name="id" value="${systemMenuInstance?.id}"/>
        <input type="hidden" name="version" value="${systemMenuInstance?.version}"/>
        <g:render template="dialog" model="[systemMenuInstance: systemMenuInstance]"/>
        <div class="buttons">
