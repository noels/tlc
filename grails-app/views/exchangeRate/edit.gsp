...
<head>
    ...
    <title><g:msg code="exchangeRate.edit" default="Edit Exchange Rate" /></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="exchangeRate.edit" default="Edit Exchange Rate" />
    <g:if test="${flash.message}">
        <div class="message"><g:msg code="${flash.message}" args="${flash.args}" default="${flash.defaultMessage}" /></div>
    </g:if>
    <g:hasErrors bean="${exchangeRateInstance}">
        <div class="errors">
            <g:listErrors bean="${exchangeRateInstance}" />
        </div>
    </g:hasErrors>
    <g:form method="post" >
        <input type="hidden" name="id" value="${exchangeRateInstance?.id}" />
        <input type="hidden" name="version" value="${exchangeRateInstance?.version}" />
        <g:render template="dialog" model="[exchangeRateInstance: exchangeRateInstance]" />
        <div class="buttons">
