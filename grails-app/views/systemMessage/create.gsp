...
<head>
    ...
    <title><g:msg code="systemMessage.create" default="Create System Message"/></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="systemMessage.create" default="Create System Message"/>
    ...
    <g:form action="save" method="post">
        <g:render template="dialog" model="[systemMessageInstance: systemMessageInstance]"/>
        <div class="buttons">
