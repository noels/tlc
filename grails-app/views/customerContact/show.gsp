...
<head>
    ...
    <title><g:msg code="customerContact.show" default="Show Customer Contact"/></title>
</head>
<body>
<div class="nav">
    <span class="menuButton"><a class="home" href="${createLink(uri: '/')}"><g:msg code="home" default="Home"/></a></span>
    <span class="menuButton"><g:link class="menu" controller="systemMenu" action="display"><g:msg code="systemMenu.display" default="Menu"/></g:link></span>
    <span class="menuButton"><g:link class="list" action="list"><g:msg code="customerContact.list" default="Customer Contact List"/></g:link></span>
...
<div class="body">
    <g:pageTitle code="customerContact.show" default="Show Customer Contact"/>
        ...
        <table>
            ...
            <g:permit activity="sysadmin">
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${display(bean: customerContactInstance, field: 'id')}</td>
            ...
            <tr class="prop">
                <td valign="top" class="name"><g:msg code="customerContact.name" default="Name"/>:</td>

                <td valign="top" class="value">${display(bean: customerContactInstance, field: 'name')}</td>
            ...
            <tr class="prop">
                <td valign="top" class="name"><g:msg code="customerContact.identifier" default="Identifier"/>:</td>

                <td valign="top" class="value">${display(bean: customerContactInstance, field: 'identifier')}</td>
            ...
            <tr class="prop">
                <td valign="top" class="name"><g:msg code="customerContact.usages" default="Usages"/>:</td>
            ...
            <g:permit activity="sysadmin">
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${display(bean: customerContactInstance, field: 'securityCode')}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${display(bean: customerContactInstance, field: 'dateCreated')}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${display(bean: customerContactInstance, field: 'lastUpdated')}</td>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="value">${display(bean: customerContactInstance, field: 'version')}</td>
