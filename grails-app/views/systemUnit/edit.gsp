...
<head>
    ...
    <title><g:msg code="systemUnit.edit" default="Edit System Unit"/></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="systemUnit.edit" default="Edit System Unit"/>
    <g:if test="${flash.message}">
        <div class="message"><g:msg code="${flash.message}" args="${flash.args}" default="${flash.defaultMessage}"/></div>
    </g:if>
    <g:hasErrors bean="${systemUnitInstance}">
        <div class="errors">
            <g:listErrors bean="${systemUnitInstance}"/>
        </div>
    </g:hasErrors>
    <g:form method="post">
        <input type="hidden" name="id" value="${systemUnitInstance?.id}"/>
        <input type="hidden" name="version" value="${systemUnitInstance?.version}"/>
        <g:render template="dialog" model="[systemUnitInstance: systemUnitInstance]"/>
        <div class="buttons">
