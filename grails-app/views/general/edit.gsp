...
<head>
    ...
    <title><g:msg code="templateDocument.edit" default="Edit Template" /></title>
...
<div class="body">
    <g:pageTitle code="templateDocument.edit" default="Edit Template"/>
    ...
    <g:form method="post" >
        ...
        <input type="hidden" name="version" value="${templateDocumentInstance?.version}" />
