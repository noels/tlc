...
<head>
    ...
    <title><g:msg code="general.journal.entry" default="General Ledger Journal Entry"/></title>
...
<div class="nav">
    ...
    <span class="menuButton"><g:link class="list" controller="document" action="templates" params="${[ctrl: 'general', types: 'GLJ']}"><g:msg code="templateDocument.load" default="Load Template"/></g:link></span>
</div>
<div class="body">
    <g:pageTitle code="general.journal.entry" default="General Ledger Journal Entry"/>
    ...
    <g:form method="post">
            ...
            <table>
                ...
                <tr class="prop">
                    ...
                    <td valign="top" class="small-value ${hasErrors(bean: documentInstance, field: 'documentDate', 'errors')}">
                        <input type="text" onchange="getPeriod(this, '${createLink(controller: 'document', action: 'period')}', '', true)" size="20" id="documentDate" name="documentDate" value="${display(bean: documentInstance, field: 'documentDate', scale: 1)}"/>&nbsp;<g:help code="document.journalDate"/>
                    </td>
        ...
        <div class="buttons">
            <span class="button"><g:actionSubmit class="save" action="journaling" value="${msg(code:'create', 'default':'Create')}"/></span>
