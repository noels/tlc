...
<head>
    ...
    <title><g:msg code="templateDocument.glj.list" default="General Ledger Journal Template List" /></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="templateDocument.glj.list" default="General Ledger Journal Template List"/>
