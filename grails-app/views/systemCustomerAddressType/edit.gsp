...
<head>
    ...
    <title><g:msg code="systemCustomerAddressType.edit" default="Edit Customer Address Type" /></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="systemCustomerAddressType.edit" default="Edit Customer Address Type"/>
    ...
    <g:form method="post" >
        ...
        <input type="hidden" name="version" value="${systemCustomerAddressTypeInstance?.version}" />
