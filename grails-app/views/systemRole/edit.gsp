...
<head>
    ...
    <title><g:msg code="systemRole.edit" default="Edit System Role"/></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="systemRole.edit" default="Edit System Role"/>
    <g:if test="${flash.message}">
        <div class="message"><g:msg code="${flash.message}" args="${flash.args}" default="${flash.defaultMessage}"/></div>
    </g:if>
    <g:hasErrors bean="${systemRoleInstance}">
        <div class="errors">
            <g:listErrors bean="${systemRoleInstance}"/>
        </div>
    </g:hasErrors>
    <g:form method="post">
        <input type="hidden" name="id" value="${systemRoleInstance?.id}"/>
        <input type="hidden" name="version" value="${systemRoleInstance?.version}"/>
        <g:render template="dialog" model="[systemRoleInstance: systemRoleInstance]"/>
        <div class="buttons">
