...
<head>
    ...
    <title><g:msg code="templateDocument.apj.list" default="Accounts Payable Journal Template List" /></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="templateDocument.apj.list" default="Accounts Payable Journal Template List"/>
