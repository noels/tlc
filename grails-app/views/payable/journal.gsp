...
<head>
    ...
    <title><g:msg code="payable.journal.entry" default="Accounts Payable Journal Entry"/></title>
...
<div class="nav">
    ...
    <span class="menuButton"><g:link class="list" controller="document" action="templates" params="${[ctrl: 'payable', types: 'APJ']}"><g:msg code="templateDocument.load" default="Load Template"/></g:link></span>
</div>
<div class="body">
    <g:pageTitle code="payable.journal.entry" default="Accounts Payable Journal Entry"/>
    ...
    <g:form method="post">
        ...
        <div class="dialog">
            <table>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="documentDate"><g:msg code="document.journalDate" default="Document Date"/>:</label>
                    </td>
                    ...
                    <td valign="top" class="name">
                        <label for="dueDate"><g:msg code="document.journal.due" default="Due Date"/>:</label>
                    </td>
                    ...
                    <td valign="top" class="name">
                        <label for="sourceAffectsTurnover"><g:msg code="generalTransaction.affectsTurnover" default="Affects Turnover"/>:</label>
                    </td>
                    <td valign="top" class="small-value ${hasErrors(bean: documentInstance, field: 'sourceAffectsTurnover', 'errors')}">
                ...
                <tr class="prop">
                    ...
                    <td valign="top" colspan="3" class="small-value ${hasErrors(bean: documentInstance, field: 'currency', 'errors')}">
        ...
        <div class="list entry">
            <table>
                <thead>
                <tr>
                    <th><g:msg code="document.supplier" default="Supplier"/>&nbsp;<g:help code="document.supplier"/></th>
                ...
                <g:each in="${documentInstance.lines}" status="i" var="documentLine">
                    <tr>
                        <td class="narrow ${hasErrors(bean: documentLine, field: 'accountCode', 'errors')}">
                            <input type="text" maxLength="20" size="20" onchange="setAccount(this, '${createLink(controller: 'document', action: 'accounts')}', 'journal', 'ap')" id="lines[${i}].accountCode" name="lines[${i}].accountCode" value="${display(bean: documentLine, field: 'accountCode')}"/>
                        </td>
