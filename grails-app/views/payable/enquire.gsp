...
<head>
    ...
    <title><g:msg code="payable.journal.enquire" default="Accounts Payable Journal Enquiry"/></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="payable.journal.enquire" default="Accounts Payable Journal Enquiry" help="document.enquire"/>
    ...
    <g:if test="${documentInstance.id}">
        <div class="list">
            <table>
                <thead>
                <tr>
                    <th><g:msg code="document.supplier" default="Supplier"/></th>
