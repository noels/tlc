...
<div class="dialog">
    <table>
        ...
        <tr class="prop">
            ...
            <td valign="top" class="name">
                <label for="sourceAffectsTurnover"><g:msg code="templateDocument.sourceAffectsTurnover" default="Affects Turnover"/>:</label>
            </td>
            <td valign="top" class="small-value ${hasErrors(bean: templateDocumentInstance, field: 'sourceAffectsTurnover', 'errors')}">
...
<div class="list entry">
    <table>
        <thead>
        <tr>
            <th><g:msg code="templateDocument.journal.supplier" default="Supplier"/>&nbsp;<g:help code="templateDocument.journal.supplier"/></th>
