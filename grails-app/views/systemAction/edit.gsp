...
<head>
    ...
    <title><g:msg code="systemAction.edit" default="Edit System Action"/></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="systemAction.edit" default="Edit System Action"/>
    ...
    <g:form method="post">
        ...
        <input type="hidden" name="version" value="${systemActionInstance?.version}"/>
        <g:render template="dialog" model="[systemActionInstance: systemActionInstance]"/>
        <div class="buttons">
