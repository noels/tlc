            ...
            <table>
                ...
                <tr class="prop">
                    <td valign="top" class="name">
                        <label for="file"><g:msg code="account.file" default="Tab Delimited Text File"/>:</label>
                    </td>
                    <td valign="top" class="value">
                        <input initialField="true" size="30" type="file" id="file" name="file"/>&nbsp;<g:help code="account.file"/>
                    </td>
                </tr>
