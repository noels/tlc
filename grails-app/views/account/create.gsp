...
<head>
    ...
    <title><g:msg code="account.create" default="Create Account"/></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="account.create" default="Create Account"/>
    ...
    <g:if test="${chartSectionList}">
        <g:form action="save" method="post">
            <g:render template="dialog" model="[accountInstance: accountInstance]"/>
            <div class="buttons">
    ...
    <g:else>
        <h2><g:msg code="account.no.sections" default="No sections found with ranges specified"/></h2>
    </g:else>
</div>
</body>
</html>
