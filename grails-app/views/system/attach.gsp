...
<div class="body">
    ...
    <div style="margin-top:20px;">
        <p style="margin-bottom:20px;"><g:msg code="companyUser.attach.text" default="You have been granted access to the test company. Please read the notes below then press the Continue button to proceed to your company menu."/></p>
