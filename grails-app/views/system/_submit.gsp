            ...
            <tr class="prop">
                ...
                <td valign="top" class="value">
                    <g:if test="${parameter.type == 'boolean'}">
                        <input initialField="${(i == 0 ? 'true' : 'false')}" type="checkbox" id="${parameter.code}" name="${parameter.code}" value="true" ${(parameter.value == 'true' ? 'checked="true"' : '')}/>
                    </g:if>
                    <g:else>
                        <input initialField="${(i == 0 ? 'true' : 'false')}" type="text" size="20" id="${parameter.code}" name="${parameter.code}" value="${parameter.value.encodeAsHTML()}"/>
                    </g:else>
