...
<head>
    ...
    <title><g:msg code="systemTracing.edit" default="Edit Tracing" /></title>
</head>
<body>
<div class="nav">
...
<div class="body">
    <g:pageTitle code="systemTracing.edit" default="Edit Tracing" />
    <g:if test="${flash.message}">
        <div class="message"><g:msg code="${flash.message}" args="${flash.args}" default="${flash.defaultMessage}" /></div>
    </g:if>
    <g:hasErrors bean="${systemTracingInstance}">
        <div class="errors">
            <g:listErrors bean="${systemTracingInstance}" />
        </div>
    </g:hasErrors>
    <g:form method="post" >
        <input type="hidden" name="id" value="${systemTracingInstance?.id}" />
        <input type="hidden" name="version" value="${systemTracingInstance?.version}" />
        <g:render template="dialog" model="[systemTracingInstance: systemTracingInstance, selectionList: selectionList]" />
        <div class="buttons">
